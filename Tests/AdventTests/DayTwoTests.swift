...
class DayTwoTests: XCTestCase {
  ...
  func testDayTwoA() {
    ...
    XCTAssertEqual(18, dayTwoA(table))
  }
  ...
  func testPuzzleInputA() {
    ...
    XCTAssertEqual(53978, dayTwoA(table))
  }

  func testPerformanceExample() {
    let row: Row = (0..<1_000).map { n in n as Int? }
    table = Table(repeating: row, count: 1_000)

    self.measure { // Average: 0.732 sec
      let _ = dayTwoA(table)
    }
  }
}
